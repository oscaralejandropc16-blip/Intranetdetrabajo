...
export default function LiveStatusBar() {
  ...
  return (
    <div className="w-full bg-slate-900/90 backdrop-blur-xl border border-amber-500/20 rounded-2xl sm:rounded-3xl p-3 sm:p-4 text-white shadow-2xl mb-6 relative z-30 transition-all">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-3 bg-slate-950/70 border border-white/5 px-3.5 sm:px-4 py-2.5 rounded-2xl shadow-inner flex-1 min-w-[200px]">
          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400 shadow-sm flex-shrink-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] sm:text-xs text-slate-400 capitalize font-medium mt-0.5 truncate">
              {formattedDate}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap sm:flex-nowrap justify-between md:justify-center">
          {/* Tarjeta USD */}
          <div className="flex items-center gap-2.5 sm:gap-3 bg-emerald-950/40 border border-emerald-500/30 px-3 sm:px-3.5 py-2 rounded-2xl flex-1 sm:flex-none shadow-sm hover:border-emerald-500/50 transition-all min-w-[130px]">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-emerald-400 flex-shrink-0 font-bold text-xs sm:text-sm">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base font-black text-white font-mono leading-tight">
          ...
          {/* Tarjeta EUR */}
          <div className="flex items-center gap-2.5 sm:gap-3 bg-blue-950/40 border border-blue-500/30 px-3 sm:px-3.5 py-2 rounded-2xl flex-1 sm:flex-none shadow-sm hover:border-blue-500/50 transition-all min-w-[130px]">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-blue-500/20 border border-blue-500/40 flex items-center justify-center text-blue-400 flex-shrink-0 font-bold text-xs sm:text-sm">
          ...
          <button
            ...
            className="p-2 sm:p-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700 text-slate-300 hover:text-white transition-all cursor-pointer flex-shrink-0 shadow-sm"
          >
        ...
        <div className="relative city-dropdown-container">
          <button
            ...
            className="flex items-center gap-3 bg-slate-950/70 hover:bg-slate-950/90 border border-white/10 hover:border-amber-500/40 px-3.5 sm:px-4 py-2 rounded-2xl transition-all cursor-pointer text-left w-full shadow-sm"
            title="Haz clic para cambiar de ciudad"
          >
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center flex-shrink-0">
